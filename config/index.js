const config = {
    ...
    // ],
    REQUIRE_PHOTOS: [
        { name: 'Predio', code: 1, require: true },
        { name: 'Medidor', code: 2, require: true },
        { name: 'Lectura Activa', code: 3, require: true },
        { name: 'Lectura Reactiva', code: 4, require: false },
        { name: 'Sello TB 1', code: 5, require: true },
        { name: 'Sello TB 2', code: 6, require: false },
        { name: 'Sello Caja', code: 7, require: false },
        { name: 'Prueba de Fuga', code: 8, require: true },
        // { name: 'Sello Tapa Principal 2', code: 9, require: true },
        // { name: 'Sello Tapa Bornera', code: 10, require: true },
        // { name: 'Sello Caja', code: 11, require: true },
        // { name: 'Sticker Cedenar', code: 12, require: true },
