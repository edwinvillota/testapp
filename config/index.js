const config = {
    ...
    // ],
    REQUIRE_PHOTOS: [
        { name: 'Número de Caja', code: 1, require: true },
        { name: 'Caja Antes', code: 2, require: true },
        { name: 'Número de Equipo', code: 3, require: true },
        { name: 'Caja Despues', code: 4, require: true },
        { name: 'Foto Adicional 1', code: 5, require: false },
        { name: 'Foto Adicional 2', code: 6, require: false },
        // { name: 'Lectura Reactiva', code: 7, require: true },
        // { name: 'Sello Tapa Principal 1', code: 8, require: true },
        // { name: 'Sello Tapa Principal 2', code: 9, require: true },
        // { name: 'Sello Tapa Bornera', code: 10, require: true },
